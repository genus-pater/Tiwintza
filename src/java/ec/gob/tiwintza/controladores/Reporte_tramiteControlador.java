...
import ec.gob.tiwintza.modelos.Reporte_tramiteModelo;
 ...
 * @author wmoina
 */
@ManagedBean(name = "dtFilterView2")
@ViewScoped

public class Reporte_tramiteControlador {

    private Reporte_tramiteEntidad objEntidad;
    private ArrayList<Reporte_tramiteEntidad> arrLisReporte;
    private ArrayList<Reporte_tramiteEntidad> arrayListReporte2;
    ...
    public Reporte_tramiteEntidad getObjEntidad() {
        return objEntidad;
    }

    public void setObjEntidad(Reporte_tramiteEntidad objEntidad) {
        this.objEntidad = objEntidad;
    }

    public ArrayList<Reporte_tramiteEntidad> getArrLisReporte() {
        return arrLisReporte;
    }

    public void setArrLisReporte(ArrayList<Reporte_tramiteEntidad> arrLisReporte) {
        this.arrLisReporte = arrLisReporte;
    }

    public ArrayList<Reporte_tramiteEntidad> getArrayListReporte2() {
        return arrayListReporte2;
    }

    public void setArrayListReporte2(ArrayList<Reporte_tramiteEntidad> arrayListReporte2) {
        this.arrayListReporte2 = arrayListReporte2;
    }
    ...
    public Reporte_tramiteControlador(Reporte_tramiteEntidad objEntidad, ArrayList<Reporte_tramiteEntidad> arrLisReporte, ArrayList<Reporte_tramiteEntidad> arrayListReporte2) {
        this.objEntidad = objEntidad;
        this.arrLisReporte = arrLisReporte;
        
    }

    public Reporte_tramiteControlador() {
        objEntidad = new Reporte_tramiteEntidad();
...
//</editor-fold>
    ...
    public void cargarReporte() {
        try {
            this.arrLisReporte = Reporte_tramiteModelo.obtenerReporte_tramite();
        } catch (Exception e) {
